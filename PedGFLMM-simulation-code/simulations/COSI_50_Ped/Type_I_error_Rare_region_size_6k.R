...
# simulations/COSI_50_Ped/Type_I_Error_Rare
...
DUMX=2  # Number of simulations (we used 2500)
...
Type_I_error_rates = Type_I_error_func (idx2 = 2, N.SIM = DUMX, causal_variant = "rare", seed =DUMZ)
