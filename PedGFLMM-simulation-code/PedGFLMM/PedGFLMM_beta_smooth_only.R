...
PedGFLMM_beta_smooth_only = function(ped, geno, covariate=NULL, pos, order, beta_basis=NULL, base = "bspline", optimizer = "bobyqa", Wald = FALSE)
   {
   ...
   out$M_gao = ifelse(is.null(beta_basis), NB$M_gao, NA)
